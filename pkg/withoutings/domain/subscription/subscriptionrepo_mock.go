...
// Update provides a mock function with given fields: ctx, sub, updateFn
func (_m *MockRepo) Update(ctx context.Context, sub *Subscription, updateFn func(context.Context, *Subscription) (*Subscription, error)) error {
	ret := _m.Called(ctx, sub, updateFn)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, *Subscription, func(context.Context, *Subscription) (*Subscription, error)) error); ok {
		r0 = rf(ctx, sub, updateFn)
	} else {
		r0 = ret.Error(0)
	}
...
func (_e *MockRepo_Expecter) Update(ctx interface{}, sub interface{}, updateFn interface{}) *MockRepo_Update_Call {
	return &MockRepo_Update_Call{Call: _e.mock.On("Update", ctx, sub, updateFn)}
}

func (_c *MockRepo_Update_Call) Run(run func(ctx context.Context, sub *Subscription, updateFn func(context.Context, *Subscription) (*Subscription, error))) *MockRepo_Update_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*Subscription), args[2].(func(context.Context, *Subscription) (*Subscription, error)))
	})
	return _c
}
...
func (_c *MockRepo_Update_Call) RunAndReturn(run func(context.Context, *Subscription, func(context.Context, *Subscription) (*Subscription, error)) error) *MockRepo_Update_Call {
	_c.Call.Return(run)
	return _c
}
