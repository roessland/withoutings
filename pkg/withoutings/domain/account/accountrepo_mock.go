...
func (_m *MockRepo) Update(ctx context.Context, withingsUserID string, updateFn func(context.Context, *Account) (*Account, error)) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, string, func(context.Context, *Account) (*Account, error)) error); ok {
		r0 = rf(ctx, withingsUserID, updateFn)
	} else {
		r0 = ret.Error(0)
	}
...
func (_c *MockRepo_UpdateAccount_Call) Run(run func(ctx context.Context, withingsUserID string, updateFn func(context.Context, *Account) (*Account, error))) *MockRepo_UpdateAccount_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string), args[2].(func(context.Context, *Account) (*Account, error)))
	})
	return _c
}

func (_c *MockRepo_UpdateAccount_Call) Return(_a0 error) *MockRepo_UpdateAccount_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockRepo_UpdateAccount_Call) RunAndReturn(run func(context.Context, string, func(context.Context, *Account) (*Account, error)) error) *MockRepo_UpdateAccount_Call {
	_c.Call.Return(run)
	return _c
}
