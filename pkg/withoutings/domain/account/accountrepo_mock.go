...
// Update provides a mock function with given fields: ctx, account, updateFn
func (_m *MockRepo) Update(ctx context.Context, account *Account, updateFn func(context.Context, *Account) (*Account, error)) error {
	ret := _m.Called(ctx, account, updateFn)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, *Account, func(context.Context, *Account) (*Account, error)) error); ok {
		r0 = rf(ctx, account, updateFn)
	} else {
		r0 = ret.Error(0)
	}
...
func (_e *MockRepo_Expecter) Update(ctx interface{}, account interface{}, updateFn interface{}) *MockRepo_Update_Call {
	return &MockRepo_Update_Call{Call: _e.mock.On("Update", ctx, account, updateFn)}
}

func (_c *MockRepo_Update_Call) Run(run func(ctx context.Context, account *Account, updateFn func(context.Context, *Account) (*Account, error))) *MockRepo_Update_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*Account), args[2].(func(context.Context, *Account) (*Account, error)))
	})
	return _c
}
...
func (_c *MockRepo_Update_Call) RunAndReturn(run func(context.Context, *Account, func(context.Context, *Account) (*Account, error)) error) *MockRepo_Update_Call {
	_c.Call.Return(run)
	return _c
}
